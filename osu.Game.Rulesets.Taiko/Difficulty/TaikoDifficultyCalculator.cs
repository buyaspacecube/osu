...
namespace osu.Game.Rulesets.Taiko.Difficulty
{
    public class TaikoDifficultyCalculator : DifficultyCalculator
    {
		...
		private const double memory_skill_multiplier = 0.100 * difficulty_multiplier; // All memory values are still subject to change
        ...
        protected override Mod[] DifficultyAdjustmentMods => new Mod[]
        {
			...
			// Hidden will go here eventually
        };
        ...
        {
			// For the moment, peaks are tracked using both reading and memory seperately
			// This is so that the easier of the two can be used for difficulty
